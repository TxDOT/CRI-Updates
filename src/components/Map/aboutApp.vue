...
<template>
    <v-dialog v-model="aboutClick" max-width="600" persistent width="500"  id="aboutApp">
        ...
        <v-card-text class="textSymb" id="buildNm"><u>Build Version: 1.7.3</u></v-card-text>
...
export default {
    ...
    data (){
      return {
        updateList:["Update overlap interaction process", "Added Ask a Question feature", "Updated editing tools", "Updated short training videos", "Updated map colors to new TxDOT blue"]
      }
    },
    methods:{
        close(){
