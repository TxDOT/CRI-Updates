...
<template>
    <v-container>
        <v-card tile id="dragNDrop" v-if="dragDropClick">
            ...
            <v-btn @click="closeDialog()" outlined tile color="#0056a9" id="btnClose"><u>close</u></v-btn>
        </v-card>
        ...
        <v-alert v-if="isProcessUpload" id="continueUpload" border="left" color="#0056a9">
...
export default {
    ...
    methods:{
        ...
        dragLeave(){
            document.getElementById('output').style.border = '2px dashed #0056a9'
        },
        drag(event){
