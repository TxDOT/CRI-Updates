...
export default{
    ...
    data(){
        return{
            ...
            currIndex: 0,
            posText: [{txt: "<p>The map opens to your county with your roads highlighted in blue. Only your county roads are editable.</p>"}, {txt: "<p>Select New Edit to begin editing. Or select a road from the map.</p>"},
